import{a as w}from"./chunk-HQBIDUJS.js";import{g as h,n as q}from"./chunk-LCKKE66J.js";import{b as _}from"./chunk-ZRHTXWIO.js";import{a as i,c as j}from"./chunk-5VYRFZ7X.js";var D=j(l=>{Object.defineProperty(l,"__esModule",{value:!0});l.setDefaultProcessors=void 0;var x=_(),p=h(),O=q(),k=w(),G=i(()=>{(function(m){let $=i((s,r,t)=>{if(typeof s>"u"||s===null)throw Error(`mapper.${r}.${t} does not have a component instance or it is null.`);let n=m.global.get(t),e=s.get(t),a=s.data[t],o=typeof a<"u"?a:typeof e<"u"?e:n,c="";return typeof o<"u"&&typeof o.map<"u"?c=o.map(function(u){let P=[...Object.keys(u)].map(d=>` data-${d}="${typeof u[d]<"u"&&u[d]!==null?u[d].toString():""}"`).join("");return`<quick-component name="${r}" ${P} ></quick-component>`}).join(""):x.logger.debug(`${r}.${t} does not have a map property`),c},"mapper");p.GlobalProcessor.setProcessor($);let f=i(function(s,r,t){let n=`
