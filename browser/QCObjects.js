...
var init_DOMCreateElement = __esm({
  "src/DOMCreateElement.ts"() {
    "use strict";
    init_platform();
    _DOMCreateElement = function(elementName) {
      let _ret_;
      if (isBrowser) {
...
var init_is_a = __esm({
  "src/is_a.ts"() {
    ...
    init_isQCObjects();
    init_ObjectName();
    is_a = function is_a2(obj, typeName) {
...
var init_RegisterClass = __esm({
  "src/RegisterClass.ts"() {
    ...
    RegisterClass = function(_class_, __namespace) {
...
var init_Package = __esm({
  "src/Package.ts"() {
    ...
    init_PrimaryCollections();
    init_RegisterClass();
    Package = function(namespace, classes = []) {
  ...
  "src/Crypt.ts"() {
    ...
    _Crypt = class __Crypt extends InheritClass {
      ...
      _new_(o) {
        ...
        let key = o.hasOwnProperty.call(o, "key") ? o.key : "";
        this.__new__(o);
  ...
  "src/CONFIG.ts"() {
    ...
    CONFIG = class _CONFIG extends InheritClass {
      ...
      get(name, _default) {
        ...
        return GlobalProcessor.processObject(_value);
      }
      static set(name, value) {
        new _CONFIG().set(name, value);
      }
      static get(name, value) {
        return new _CONFIG().set(name, value);
      }
    };
...
var init_serviceLoader = __esm({
  "src/serviceLoader.ts"() {
    ...
    init_platform();
    init_top();
    serviceLoader = function(service, _async = false) {
...
var init_componentLoader = __esm({
  "src/componentLoader.ts"() {
    ...
    init_platform();
    init_top();
    componentLoader = function(component, _async) {
      let __promise__;
      ...
      const _componentLoaderInNode = function(component2) {
        __promise__ = new Promise(function(resolve, reject) {
...
var init_ComponentFactory = __esm({
  "src/ComponentFactory.ts"() {
    ...
    _buildComponentFromElement_ = function(element, __parent__) {
    ...
    _buildComponentsFromElements_ = function(elements, __parent__) {
...
var init_top = __esm({
  "src/top.ts"() {
    ...
    setConfigService = (_configService) => {
...
var init_super = __esm({
  "src/super.ts"() {
    "use strict";
    init_ClassFactory();
    _super_ = function(className, classMethodName) {
...
var init_NamespaceRef = __esm({
  "src/NamespaceRef.ts"() {
    ...
    init_isQCObjects();
    init_Package();
    NamespaceRef = function(namespace) {
...
var init_range = __esm({
  "src/range.ts"() {
    "use strict";
    init_introspection();
    range = function(start, stop = 0, step = 1) {
...
var init_Tag = __esm({
  "src/Tag.ts"() {
    ...
    Tag = function(tagname, innerHTML) {
...
var init_findPackageNodePath = __esm({
  "src/findPackageNodePath.ts"() {
    ...
    init_Logger();
    init_platform();
    findPackageNodePath = function(packagename) {
      let sdkPath = null;
      if (!isBrowser) {
        const fs = _require_("fs");
        try {
...
var init_Import = __esm({
  "src/Import.ts"() {
    ...
    init_platform();
    init_PrimaryCollections();
    Import = function(packagename, ready2, external) {
      if (external !== void 0) {
      ...
      if (typeof _top2.__qcobjects__.loaded === "undefined") {
        ...
        if (isBrowser) {
          ...
          Element.prototype.render = function QC_Render(content) {
            const _self = this;
            const _appendVDOM = (_self2, content2) => {
...
var RegisterWidgets = function(...args) {
