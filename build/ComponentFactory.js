...
const _buildComponentFromElement_ = function (element, __parent__) {
    ...
    let componentURI;
    componentURI = (0, exports.ComponentURI)({
    ...
    if (CONFIG_1.CONFIG.get("preserveComponentBodyTag")) {
        (0, Package_1.Package)((_componentName !== "") ? ("com.qcobjects.components." + _componentName + "") : ("com.qcobjects.components"), [
            (0, Class_1.Class)("ComponentBody", (0, ClassFactory_1.ClassFactory)("Component"), {
                name: _componentName,
                tplsource,
                tplextension,
                reload: true
    ...
    const __create_component_instance_ = function () {
        const __shadowed = (__shadowed_not_set) ? ((__classDefinition && __classDefinition.shadowed) || (0, ClassFactory_1.ClassFactory)("Component").shadowed) : (shadowed);
        const __definition = {
            __parent__,
            name: _componentName,
            cached: (__cached_not_set) ? ((0, ClassFactory_1.ClassFactory)("Component").cached) : (cached),
            shadowed: __shadowed,
            tplextension,
...
const buildComponents = (element, rebuildObjects = false) => {
