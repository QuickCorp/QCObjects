...
const setDefaultProcessors = () => {
    (function (_top) {
        ...
        Processor_1.Processor.setProcessor(mapper);
        ...
        Processor_1.Processor.setProcessor(layout);
        ...
        Processor_1.Processor.setProcessor(component);
        ...
        Processor_1.Processor.setProcessor(quick_component);
        ...
        Processor_1.Processor.setProcessor(repeat);
    })(top_1._top);
};
