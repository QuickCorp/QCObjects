...
class Component extends InheritClass_1.InheritClass {
    ...
    constructor({ __parent__, templateURI = "", template, tplsource = "default", tplextension, url = "", name = "", method = "GET", data = {}, reload = false, shadowed = false, cached = true, _body = (0, DOMCreateElement_1._DOMCreateElement)("div"), __promise__ = null, __shadowRoot, body, shadowRoot, splashScreenComponent, controller, view }) {
        ...
        self.processorHandler = (0, New_1.New)(Processor_1.Processor, {
            component: self
        });
    ...
    createServiceInstance() {
        ...
        const _serviceClassName = (platform_1.isBrowser && body.getAttribute("serviceClass") !== null) ? (body.getAttribute("serviceClass")) : (null);
        return new Promise(function (resolve, reject) {
            /* __enable_service_class__ = true by default */
            const __enable_service_class__ = !!(((Object.hasOwnProperty.call(body, "enableServiceClass") && body.enableServiceClass) ||
                (!Object.hasOwnProperty.call(body, "enableServiceClass"))));
            let _response_to_data_ = !!((platform_1.isBrowser && body.getAttribute("response-to") !== null && body.getAttribute("response-to") === "data"));
            let _response_to_template_ = !!((platform_1.isBrowser && body.getAttribute("response-to") !== null && body.getAttribute("response-to") === "template"));
            ...
            if (typeof __serviceClass !== "undefined" &&
                ...
                (0, serviceLoader_1.serviceLoader)(serviceInstance)?.then(function ({ request, service }) {
                    let serviceResponse;
    ...
    get bodyAttributes() {
        ...
        return (platform_1.isBrowser) ? ([...c.getAttributeNames()].map(a => { return { [a]: c.getAttribute(a) }; }).reduce((accumulator, colData, index) => { return Object.assign(accumulator, colData); })) : ({});
    }
    get dataAttributes() {
        const _component_ = this;
        const c = _component_.body;
        return (platform_1.isBrowser) ? ([{}].concat([...c.getAttributeNames()].filter(n => n.startsWith("data-")).map(a => { return { [a.split("-")[1]]: c.getAttribute(a) }; })).reduce((accumulator, colData, index) => { return Object.assign(accumulator, colData); })) : ({});
    }
...
(introspection_1._methods_)((0, ClassFactory_1.ClassFactory)("Component")).map(function (__c__) {
